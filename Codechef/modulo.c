...
void main()
{
    ...
    if(x%5==0)
    {
        ...
        printf("Enter a multiple of 5 value !! ");
    }
}
...
number with two digits of precision. If there is not enough money in the account to complete the transaction, output the current
 bank balance.
